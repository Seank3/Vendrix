  ...
  return (
    <div className="vx-page">
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ fontSize: 18, fontWeight: 700, letterSpacing: '-0.02em', marginBottom: 3 }}>Organizations</h1>
      ...
      <div className="vx-card" style={{ padding: 40, textAlign: 'center', color: 'var(--text-muted)' }}>
        ...
        <div style={{ fontSize: 14, fontWeight: 500, color: 'var(--text-secondary)' }}>Organizations module coming soon</div>
